...
def vote_round1(no_loyal, on_tie):
    '''
    Compute list with votes to send to loyal nodes
    '''
    result_vote = []
...
def vote_round2(no_loyal, no_total, on_tie):
    '''
    Compute byzantine vectors for round 2
    '''
